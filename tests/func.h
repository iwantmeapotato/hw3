...
public:
  ...
  bool straighten() {
    ...
    while (bal_chk >> curr) {
      ...
      if ((prev == '+' && curr == '+') || (prev == '-' && curr == '-') || (prev == '*' && curr == '*') || (prev == '/' && curr == '/') || (prev == '(' && curr == '*') || (prev == '(' && curr == '/') || (prev == '+' && curr == '-') || (prev == '+' && curr == '/') || (prev == '+' && curr == '*') || (prev == '-' && curr == '+') || (prev == '-' && curr == '/') || (prev == '-' && curr == '*') || (prev == '*' && curr == '+') || (prev == '*' && curr == '-') || (prev == '*' && curr == '/') || (prev == '/' && curr == '+') || (prev == '/' && curr == '-') || (prev == '/' && curr == '*') || (prev == '+' && curr == ')') || (prev == '-' && curr == ')') || (prev == '*' && curr == ')') || (prev == '/' && curr == ')') || (prev == ')' && curr == '(') || (prev == '(' && curr == ')') || (prev == ')' && isdigit(curr)) || (isdigit(prev) && curr == '(') || (prev == '!' && curr == '*') || (prev == '!' && curr == '/') || ((bal_chk.peek() == -1) && (curr == '-' || curr == '+' || curr == '*' || curr == '/')) || (!isdigit(curr) && (curr != '+' && curr != '-' && curr != '*' && curr != '/' && curr != '(' && curr != ')')) ) return false;
      for (int i = 0; i < 3; i++) {
